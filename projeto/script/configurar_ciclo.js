...
async function listarGastos() {
    const response = await fetch(`http://localhost:3000/gastos/${id_ciclo}`);
...
async function listarReceita() {
    const result = await fetch(`http://localhost:3000/receita/${id_ciclo}`);
...
async function deletarGastos(event, id) {
    ...
    await fetch(`http://localhost:3000/deletar/gastos/${id}`, {
        method: "DELETE"
    });
...
async function deletarReceitas( event, id) {
    ...
    const resut = await fetch(`http://localhost:3000/receita/deletar/${id}`,{
    method: "DELETE"
 }
)
...
async function deletarCiclo() {
    ...
    const response = await fetch(`http://localhost:3000/ciclo/${id_ciclo}`, {
        method: "DELETE"
    });
...
const relatorio_nome = await fetch(`http://localhost:3000/ciclo/${id_usuario}`,{
  headers: {
...
const result = await fetch(`http://localhost:3000/encerrar-ciclo/${id_usuario}/${id_ciclo}`, {
        method: "POST",
                headers: {
